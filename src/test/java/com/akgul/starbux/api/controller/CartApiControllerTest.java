...
public class CartApiControllerTest {
    ...
    public void shouldUpdateProductQuantity() {
        ...
        Product drinkProduct = productService.getProductById(1L);
    ...
    public void shouldGetCart() {
        ...
        CartItem cartItem = new CartItem();
        cartItem.setDrinkProduct( productService.getProductById(1L));
        cartItem.setQuantity(1);
        cartItems.add(cartItem);
    ...
    @Test
    public void shouldAddSideProductToCart() {
        Cart cart = new Cart();
        List<CartItem> cartItems = new ArrayList<>();
        Product drinkProduct = productService.getProductById(1L);
        Product sideProduct = productService.getProductById(6L);
        ...
        ResponseEntity<Cart> cartResponse = restTemplate.exchange(createApiUrl("/cart/add/side/6/" + cart.getCartItems().get(0).getId()), HttpMethod.POST, httpEntity, Cart.class);

        Assert.assertEquals(cartResponse.getBody().getTotalAmount().toString(), "7.00");
    ...
    public void shouldDeleteCartItem() {
        Cart cart = new Cart();
        List<CartItem> cartItems = new ArrayList<>();
        Product drinkProduct = productService.getProductById(3L);
        Product drinkProduct2 = productService.getProductById(4L);
        ...
        cartItem2.setDrinkProduct(drinkProduct2);
